...
public class AppConfig {
    ...
    public static String DOMAIN_URL = BuildConfig.BASE_URL;
    ...
    public static String APP_VERSION_CODE    = String.valueOf(BuildConfig.VERSION_CODE);
    public static String APP_UPDATE = BuildConfig.VERSION_NAME ;
    public static String SOURCE = "mobile";
    public static final int LOCATION_REQUEST = 1000;
    public static final int GPS_REQUEST = 1001;

    public static String DEVICE_VERSION = BuildConfig.VERSION_NAME ;
    ...
    public static String HEAD_X_API_KEY = BuildConfig.HEAD_X_API_KEY;
    public static String NETPAISA_PASS_KEY = BuildConfig.NETPAISA_PASS_KEY;
    ...
    public static String IMSI = BuildConfig.IMSI ;
